...
public class FirstFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        whyContent = "Through this event, IIIT Una has taken an initiative to provide an opportunity for young technocrats to showcase their technical skills. We aim to promote a new level of healthy competitive fervour and electronics culture among various institutes.";
